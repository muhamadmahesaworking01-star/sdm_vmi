                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="biodata-readonly">
                                         ...
                                         <form action="{{ route('employees.update', $teacher) }}" method="POST" enctype="multipart/form-data" class="biodata-edit d-none">
                                            @csrf @method('PUT')
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-4"><label class="form-label">Agama</label><select name="agama" class="form-select"><option value="">Belum diisi</option>@foreach(['Islam','Kristen','Katolik','Hindu','Buddha','Konghucu','Lainnya'] as $agama)<option value="{{ $agama }}" @selected($teacher->agama === $agama)>{{ $agama }}</option>@endforeach</select></div>
