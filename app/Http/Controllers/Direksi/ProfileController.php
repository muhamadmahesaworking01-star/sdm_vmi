...
class ProfileController extends Controller
{
    ...
    {
        $data = $request->validate(['nama' => ['required', 'string', 'max:255'], 'email' => ['required', 'email', 'max:255'], 'ktp' => ['nullable', 'digits:16'], 'jabatan_internal' => ['nullable', 'string', 'max:255'], 'telepon' => ['required', 'string', 'max:255'], 'agama' => ['nullable', 'string', 'max:32'], 'alamat' => ['required', 'string'], 'catatan_akses' => ['nullable', 'string', 'max:1000']]);
